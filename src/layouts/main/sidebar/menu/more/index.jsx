...
export default function More() {
	return(
		<Popover className="relative  ">
			...
			<Popover.Button className="py-[3px] group w-full text-left outline-none">
				...
				<div className="p-3 rounded-full transition-colors float-left inline-flex items-center gap-5 group-hover:bg-[color:var(--background-third)]">
					...
					<div className="w-[1.641rem] h-[1.641rem] relative">
						<svg viewBox="0 0 24 24" className="h-[1.5rem]" fill="currentColor">
							<path
			...
			<Popover.Panel className="w-[318px] absolute bottom-0 left-0 rounded-xl overflow-hidden bg-[color:var(--background-primary)] shadow-box shadow-white">
            ...
            <div className=" h-px bg-[color:var(--background-third)] w-[89%] my-0.5 mx-auto"/>
				   ...
				   {({ open }) => (
					<>
						<Disclosure.Button className="flex items-center justify-between w-full p-4 font-bold hover:bg-[color:var(--background-secondary)] transition-colors">
							Creator Studio
							<svg className={classNames("h-[1.172rem] transition-transform", {
                  ...
                  <Disclosure.Button className="flex items-center justify-between w-full p-4 font-bold hover:bg-[color:var(--background-secondary)] transition-colors">
					   ...
					   <Disclosure.Panel>
						   ...
						   <button 
								...
								className="flex items-center w-full px-3 h-11 gap-3 font-medium hover:bg-[color:var(--background-secondary)] transition-colors"
							>
							   <svg viewBox="0 0 24 24" className="h-[1.172rem]" >
								   <path 
									   fill="currentColor"
