...
export default function More() {
    return(
        <Popover className="relative">
            ...
            <Popover.Button className="py-[3px] block group w-full outline-none">
            ...
            <Popover.Panel className="w-[318px] absolute bottom-0 left-0 rounded-xl overflow-hidden bg-black shadow-box shadow-white">
                ...
                <button className="px-4 h-14 w-full transition-colors float-left inline-flex items-center gap-5 hover:bg-[#eff3f41a]">
                    <div className="w-[26.25px] h-[26.25px] relative">
                        <svg viewBox="0 0 24 24" width={26.25} height={26.25} fill="#fff">
                        <path
