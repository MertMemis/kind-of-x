...
export default function Search () {
   ...
   return (
      <div 
         ...
         <label className=" relative h-[43px] rounded-full bg-[color:var(--background-third)] block w-full group border-2 border-transparent focus-within:border-[color:var(--color-primary)]">
            ...
            <input 
               type ="text" 
               className =" w-full h-full bg-transparent rounded-full outline-none pl-[56px] text-[15px] focus-within:bg-[color:var(--background-primary)] group-focus-within:text[color:var(--color-primary)]" 
               placeholder="Search"
               value = {query}
