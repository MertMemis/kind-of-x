...
import { _setBackgroundColor } from "../../store/display";
import { useDisplay } from "../../store/display/hooks";
import classNames from "classnames";
import {setBackgroundColor, setBoxShadow, setColor, setFontSize} from "../../store/display/actions"
import { colors, fontSizes } from "../../Utils/consts";
import { useEffect, useState } from "react";

export default function DisplayModal({ close }) {

   const {backgroundColor ,color, fontSize} = useDisplay()
   ...
   return(
      <div className=" w-[600px]">
         <h3 className=" mt-8 mb-3 text-[1.438rem] leading-7 font-extrabold text-center">Customize your view</h3>
         <div className=" p-8 pt-0">
            ...
            <div className=" mx-8 mb-4 ">
               <div className="border border-[color:var(--background-third)] px-4 flex py-3 gap-3 rounded-2xl pointer-events-none">
                  <img 
                  ...
                  <div className=" flex-1 flex flex-col">
                     ...
                     <div className=" text-[color:var(color-base)] leading-5">
                        At the heart of X are short messages called posts — just like this one — which can include photos, videos, links, text, hashtags, and mentions like <span className=" text-[color:var(--color-primary)]">@X</span>.
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div className="grid gap-3">
               ...
               <section>
                  ...
                  <div className="bg-[color:var(--background-secondary)] p-4 rounded-2xl flex items-center gap-5">
                     ...
                     <div className=" h-1 bg-[color:var(--color-secondary)] flex-1 rounded-full relative">
                        <div style={{width: fontSizePercent}} className=" h-full top-0 left-0 rounded-full bg-[color:var(--color-primary)]"></div>
                  ...
                  <div className="bg-[color:var(--background-secondary)] py-2 mb-3 rounded-2xl flex justify-around items-center">
                     {colors.map((c, index) => (
                        <button
                           ...
                           style={{'--bg': c.primary}}
                           className=" w-[36px] h-[36px] rounded-full bg-[color:var(--bg)] items-center justify-center flex text-white"
                        >
               ...
               <div className=" py-2 px-3.5 mb-3 grid grid-cols-3 gap-2 bg-[color:var(--background-secondary)] rounded-2xl">
                  <button 
                     onClick={() => {
                        setColor({
                           ...color,
                     ...
                     className={classNames("h-[62px] pr-3 pl-2 bg-white text-[#0f1419] font-bold border-2 border-white/10 rounded group flex items-center gap-1.5", {
                        "!border-[color:var(--color-primary)] !border-2": backgroundColor.name === 'light'
                     })}
                  >
                     <div className=" w-[40px] h-[40px] rounded-full flex-shrink-0 group-hover:bg-black/10 flex items-center justify-center">
                  ...
                  <button 
                     ...
                     className={classNames("h-[62px] pr-3 pl-2 bg-[#15202b] text-[#f7f9f9] font-bold border-2 border-white/10 rounded group flex items-center gap-1.5", {
                  ...
                  <button 
                     ...
                     className={classNames("h-[62px] pr-3 pl-2 bg-black text-[#f7f9f9] font-bold border-2 border-white/10 rounded group flex items-center gap-1.5", {
