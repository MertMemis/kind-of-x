...
import {setBackgroundColor, setBoxShadow, setColor} from "../../store/display/actions"
import { colors } from "../../Utils/consts";

export default function DisplayModal({ close }) {

   const {backgroundColor ,color} = useDisplay()

   return(
      <div className=" w-[600px]">
         <h3 className=" mt-8 mb-3 text-[23px] leading-7 font-extrabold text-center">Customize your view</h3>
            ...
            <div className="grid gap-3">
                  ...
                  <div className="bg-[color:var(--background-secondary)] py-2 mb-3 rounded-2xl flex justify-around items-center">
                     {colors.map((c, index) => (
                        <button
                           ...
                           style={{'--bg': c.primary}}
                           className=" w-9 h-9 rounded-full bg-[color:var(--bg)] items-center justify-center flex text-white"
                        >
               ...
               <div className=" py-2 px-3.5 mb-3 grid grid-cols-3 gap-2 bg-[color:var(--background-secondary)] rounded-2xl">
                  <button 
                     ...
                     className={classNames("h-16 pr-3 pl-2 bg-white text-[#0f1419] font-bold border-2 border-white/10 rounded group flex items-center gap-1.5", {
                  ...
                  <button 
                     ...
                     className={classNames("h-16 pr-3 pl-2 bg-[#15202b] text-[#f7f9f9] font-bold border-2 border-white/10 rounded group flex items-center gap-1.5", {
                  ...
                  <button 
                     ...
                     className={classNames("h-16 pr-3 pl-2 bg-black text-[#f7f9f9] font-bold border-2 border-white/10 rounded group flex items-center gap-1.5", {
