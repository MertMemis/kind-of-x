...
export default function Post({ post }) {
   return (
      <div className=" px-4 py-3 gap-3 border-b border-[color:var(--background-third)] flex relative before:absolute before:opacity-50 before:inset-0 before:z-[-1] before:transition-colors before:hover:bg-[color:var(--background-secondary)]">
